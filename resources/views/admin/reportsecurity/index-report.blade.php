...
@section('title', 'Serangan Keamanan')
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item active">Serangan Keamanan</li>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <x-card>
                <x-slot name="header">
                    <button onclick="addForm('{{route('reportsecurity.store')}}')"
    ...
    <!-- Form Modal -->
    @include('admin.reportsecurity.form-report')
    <!-- End Form Modal -->
    ...
    <script>
        ...
        $(function(){
            table= $('.table').DataTable({
                processing: true,
                autoWidth: false,
                ajax: { url: '{{route('report.security.datas')}}'},
                columns:
                [
                    {data: 'DT_RowIndex', name: 'DT_RowIndex', sortable: false, searchable: false},
                    {data: 'name_opd', name: 'name_opd', sortable: false},
