...
@section('title', 'Link Layanan')
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item active">Link Layanan</li>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <x-card>
                <x-slot name="header">
                    <button onclick="addForm('{{route('thumbnail.store')}}')"
    ...
    <!-- Form Modal -->
    @include('admin.thumbnail.form-thumbnail')
    <!-- End Form Modal -->
    ...
    <script>
        ...
        $(function(){
            table= $('.table').DataTable({
                processing: true,
                autoWidth: false,
                ajax: { url: '{{route('thumbnail.datas')}}'},
                columns:
                [
                    ...
                    {data: 'title', name: 'title', sortable: false},
                    {
                        ...
                        render: function(data, type, full, meta) {
                            var imagePath = '{{ asset('storage/image-thumbnail/') }}/' + data;
            ...
            $.get(url)
                .done(response => {
                    ...
                    if (response.data.image) {
                        const imagePath = '{{ asset('storage/image-thumbnail/') }}/' + response.data.image;
