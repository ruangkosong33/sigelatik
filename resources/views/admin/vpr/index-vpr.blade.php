...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <x-card>
                <x-slot name="header">
                    <button onclick="addForm('{{route('vpr.store')}}')"
        ...
        $(function(){
            table= $('.table').DataTable({
                ...
                [
                    ...
                    {data: 'ip_public', name: 'ip_public', sortable: false},
                    {data: 'ip_local', name: 'ip_local', sortable: false},
