...
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item active">WHM / C-Panel</li>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <x-card>
                <x-slot name="header">
                    <button onclick="addForm('{{route('whm.store')}}')"
