...
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item active">Laporan Jaringan</li>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <x-card>
                <x-slot name="header">
                    <button onclick="addForm('{{route('reportnetwork.store')}}')"
    ...
    <!-- Form Modal -->
    @include('admin.reportnetwork.form-report')
    <!-- End Form Modal -->
    ...
    <script>
        ...
        $(function(){
            table= $('.table').DataTable({
                processing: true,
                autoWidth: false,
                ajax: { url: '{{route('report.network.datas')}}'},
                columns:
                [
