...
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item active">Jaringan Intranet</li>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <x-card>
                <x-slot name="header">
                    <button onclick="addForm('{{route('intranet.store')}}')"
    ...
    <!-- Form Modal -->
    @include('admin.intranet.form-intranet')
    <!-- End Form Modal -->
